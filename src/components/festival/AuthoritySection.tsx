  ...
  <section className="py-20 md:py-28 px-4">
    <div className="max-w-6xl mx-auto">
      ...
      <p className="text-muted-foreground text-center max-w-3xl mx-auto mb-14 font-body text-base md:text-lg leading-relaxed">
        Somos a referência para quem busca uma experiência autêntica e inesquecível. Nossa autoridade é construída em anos de experiência e na confiança de milhares de viajantes brasileiros que já exploraram a Tailândia com nossos guias.
      </p>
      ...
      <div className="bg-card border-glow rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
        <h3 className="text-2xl font-display font-bold mb-4 text-center">Quem Somos: Especialistas em Tailândia</h3>
        <p className="text-muted-foreground font-body text-base md:text-lg leading-relaxed text-center">
          Somos um time de brasileiros apaixonados pela Tailândia que decidiu compartilhar todas as experiências vivendo e explorando este país mágico desde 2006. Durante quase duas décadas, participamos de festivais únicos como o Yi Peng e Loy Krathong, visitamos templos sagrados, desbravamos trilhas secretas e descobrimos ilhas paradisíacas.
        </p>
