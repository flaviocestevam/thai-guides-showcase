...
const racha = make(ilhasMeta[13], {
  bgGradient: "from-stone-900 via-background to-slate-950",
  seoTitle: "Koh Racha (Raya) — Day-trip premium de Phuket",
  seoDescription: "Yai ou Noi? Qual tour pegar, qual beach club vale a diária e como fugir do circuito de excursão grande em Koh Racha.",
  heroTitle: "Koh Racha — day-trip",
  heroHighlight: "premium do Andaman",
  heroSubtitle: "A 30 minutos de speedboat de Phuket, Koh Racha (ou Raya) é onde os beach clubs mais bonitos do Andaman estão. Day-trip honesto, snorkel decente e sunset que vale a viagem inteira.",
  heroWarning: "Quem fecha tour com agência de hotel paga 2x. Quem confunde Yai e Noi pode acabar na praia errada.",
  pains: [
    { title: "Fechou tour com a agência do hotel", desc: "Preço inflado, barco grande, snorkel rápido. Operadora direta entrega o dobro pelo mesmo preço." },
    { title: "Errou entre Yai e Noi", desc: "Yai é mais estruturada, Noi é mais selvagem. Comparativo no guia." },
    { title: "Não pegou o beach club certo", desc: "The Racha Resort tem day pass que vale o ingresso. Outros são turismo de massa." },
    { title: "Voltou antes do sunset", desc: "Sunset em Racha é evento. Tour padrão volta às 15h, perdendo a melhor hora." },
  ],
  features: [
    { title: "Yai ou Noi: o teste", desc: "3 perguntas pra escolher certa." },
    { title: "Operadoras diretas comparadas", desc: "5 operadoras com preço, barco e o que incluem." },
    { title: "Beach clubs com day pass", desc: "The Racha e alternativas — quais valem a diária." },
  ],
  comparison: {
    theirs: ["Tour pela agência do hotel", "Yai sem comparar", "Beach club genérico", "Voltar às 15h", "Snorkel rápido no mesmo spot"],
    ours: ["Operadora direta 40% off", "Yai vs Noi decidido pelo teste", "The Racha day pass", "Sunset tour até 19h", "Snorkel em 4 spots diferentes"],
  },
  authority: {
    title: "5 day-trips em Racha — Yai e Noi",
    paragraphs: [
      "Visitei Racha em 5 day-trips diferentes nos últimos 2 anos. Testei sunrise tour, sunset tour, day pass em resort e até overnight.",
      "O guia consolida o que vale e o que é cilada em day-trip premium de Phuket.",
    ],
    bullets: ["5 day-trips testados", "Sunrise e sunset", "Day pass The Racha vivido"],
  },
  modules: [
    { title: "Yai ou Noi", desc: "Comparativo direto.", bullets: ["Tamanho", "Praias", "Estrutura", "Vibe"] },
    { title: "Como chegar", desc: "Operadoras de Phuket.", bullets: ["Saída Chalong", "Speedboat 30 min", "Tour vs travessia", "Tabela preço"] },
    { title: "Operadoras top 5", desc: "Comparativo direto.", bullets: ["Snorkel 4 spots", "Sunset tour", "Privado", "Barco compartilhado"] },
    { title: "Day pass The Racha", desc: "Resort premium aberto a visitantes.", bullets: ["O que inclui", "Reserva direta", "Almoço", "Spa"] },
    { title: "Overnight em Racha", desc: "Quando vale dormir.", bullets: ["Sunrise mágico", "Snorkel privado", "Hotéis Yai", "Bangalôs Noi"] },
  ],
  bonuses: [
    { title: "Comparativo Yai vs Noi", desc: "Tabela com 10 critérios pra decidir em 5 minutos.", value: "R$ 47" },
    { title: "Operadora direta com 40% off", desc: "Como reservar fora da agência de hotel.", value: "R$ 67" },
    { title: "Day pass The Racha", desc: "Como reservar, o que inclui e quando vale.", value: "R$ 57" },
    { title: "Roteiro sunset tour", desc: "PDF com horário, snorkel e onde tomar o sunset.", value: "R$ 47" },
    { title: "Grupo de viajantes brasileiros", desc: "Brasileiros em Phuket agora.", value: "R$ 97" },
  ],
  testimonials: [
    { name: "Marcos T.", city: "São Paulo", text: "Operadora direta indicada pelo guia: 1.800 baht em vez dos 3.200 da agência. Mesmo barco." },
    { name: "Helena B.", city: "Rio de Janeiro", text: "Day pass no The Racha foi o melhor dia em Phuket inteiro. Piscina infinita, almoço gourmet." },
    { name: "Diego R.", city: "Curitiba", text: "Sunset tour até 19h em Racha. Voltei com cor de quem fez viagem pro Mediterrâneo." },
    { name: "Renata M.", city: "BH", text: "Escolhi Noi pelo teste do guia. Bangalô com pé na areia por R$ 480 a diária. Sonho." },
    { name: "Lucas P.", city: "Porto Alegre", text: "4 spots de snorkel diferentes em vez do mesmo lugar lotado. Diferença abissal." },
    { name: "Carla A.", city: "Brasília", text: "Quase fui pra Phi Phi de novo. Mudei pra Racha pelo guia. Outra dimensão de tranquilidade." },
  ],
  faqs: [
    { q: "Yai ou Noi?", a: "Yai pra estrutura e day pass de resort. Noi pra selvagem e snorkel autêntico." },
    { q: "Vale dormir em Racha?", a: "Sim, se quer praia vazia ao amanhecer. Day-trip resolve pra maioria." },
    { q: "Quanto custa o day-trip?", a: "Operadora direta: R$ 350-450. Agência de hotel: R$ 700+. Detalhe no guia." },
    { q: "É bom pra snorkel?", a: "Sim, visibilidade alta, fauna boa. Não é Similan, mas é o melhor day-trip de Phuket." },
    { q: "Quando ir?", a: "Nov-abr. Maio-out tem monção do Andaman." },
    { q: "É para criança?", a: "Sim, mar calmo na Patok Beach (Yai). Detalhe no guia." },
  ],
  finalCTA: {
    title: "Racha é o day-trip de Phuket que vale o ingresso",
    subtitle: "Operadora certa, ilha certa, beach club certo. Em um guia.",
  },
});
