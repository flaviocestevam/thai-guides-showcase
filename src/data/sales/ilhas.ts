...
const chang = make(ilhasMeta[5], {
  ...
  features: [
    ...
    { title: "Santuário ético confirmado + critério antifraude", desc: "O único santuário sério em Chang + o filtro objetivo pra reconhecer qualquer outro que se diz ético." },
  ...
  comparison: {
    ...
    ours: [
      ...
      "Tabela de 8 rotas com horário e preço",
      "Único santuário ético + critério antifraude",
      "Cachoeira na janela certa (tabela mensal)",
      "4 night markets com endereço — R$ 12 por refeição",
      "Roteiro 7-10 dias norte + sul + Mak/Kood",
      "1 saque grande + Aeon Bank — taxa mínima",
  ...
  authority: {
    ...
    paragraphs: [
      "Rodei Koh Chang inteira de scooter em 2 viagens diferentes, dormi em 6 hotéis nas 5 praias principais, visitei o único santuário ético da ilha e auditei os que se dizem éticos pra confirmar quais respeitam o animal de verdade.",
      "Chang não tem tour pronto pra brasileiro. Esse guia é o primeiro mapa honesto da ilha em português.",
    ],
    bullets: ["8 dias na ilha", "6 hotéis testados", "7 praias-bairro mapeadas", "Santuário ético confirmado", "Cachoeira mês a mês"],
  },
  modules: [
    { title: "Praias por perfil", desc: "7 praias-bairro com tom: agito, família, mochileiro, autêntico.", bullets: ["White Sand (e quando faz sentido)", "Klong Prao família", "Kai Bae sunset com ilhotas", "Lonely Beach mochileiro", "Bang Bao + Salakphet autênticos"] },
    { title: "Ferry, logística e Camboja", desc: "Trat ⇄ Chang ⇄ Mak/Kood ⇄ fronteira sem perder barco.", bullets: ["2 portos de saída em Trat", "Ferries sazonais para Mak/Kood/Wai", "Songthaew por destino", "Mini-van Bangkok direta", "Combinando com Camboja"] },
    { title: "Elefante ético e natureza", desc: "O único santuário sério + critério para reconhecer falsos.", bullets: ["Ban Kwan Chang explicado", "Por que banho é tortura", "4 sinais de santuário falso", "Cachoeira mês a mês", "Trilha pra Long Beach (Hat Yao)"] },
  ...
  bonuses: [
    ...
    { title: "Cachoeira mês a mês", desc: "12 meses com status e dica — para não pagar ingresso à toa.", value: "R$ 47" },
