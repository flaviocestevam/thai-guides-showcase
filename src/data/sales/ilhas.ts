...
const samui = make(ilhasMeta[1], {
  ...
  features: [
    { title: "Não reserve em Chaweng pra lua de mel (erro #1)", desc: "4 bairros decodificados — Bophut/Choeng Mon custam o MESMO de Chaweng, sem balada às 3h nem walking street com prostituição." },
    { title: "Durma em resort que entrega (não no que paga review)", desc: "12 hotéis testados de R$ 280 a R$ 1.400 — os 3 top do Booking que NÃO valem, e a boutique de R$ 420 com mesma estrutura da de R$ 780." },
    { title: "Faça 3 ilhas no preço de 1 (Samui+Phangan+Tao)", desc: "Roteiros 7 e 10 dias com ferries, hospedagem e timing certo de Full Moon — quem fica só em Samui paga caro pra ver 1/3." },
    { title: "Vá na praia certa no mês certo", desc: "8 praias × 12 meses: Chaweng, Lamai, Bophut, Maenam, Lipa Noi, Bang Por, Choeng Mon, Silver Beach — quando rende e quando é aposta." },
    { title: "Rode a ilha em scooter sem se perder", desc: "Loop de 51 km com km/min/risco em 8 trechos — meio dia vale mais que tour de 8h em van lotada." },
    { title: "Vá no mês exato pro SEU perfil", desc: "Lua de mel, família, mochileiro, Full Moon, retreat, surf iniciante — cada um tem janela e mês ideal." },
    { title: "Escolha entre Samui, Phangan e Tao sem chutar", desc: "Tabela de 8 dimensões pra decidir qual ilha (ou combo) combina com sua viagem." },
    { title: "Pegue o ferry certo (não perca meio dia)", desc: "Lomprayah vs. Seatran vs. Raja — porto, horário e qual realmente cumpre. Comprar errado = perder aula de mergulho no Tao." },
    { title: "Veja Ang Thong sem cair em barco superlotado", desc: "5 modalidades de barco com preço e operadora — do speedboat compartilhado ao iate privado." },
    { title: "Faça wellness real, não armação", desc: "6 spas e retreats: Kamalaya (7 dias premiado) ao quiosque honesto de 250 baht na rua." },
    { title: "Conheça o Samui sem Chaweng", desc: "Lipa Noi (único sunset real), Bang Por (praia 4km vazia) e vila muçulmana de pescadores em Hua Thanon." },
    { title: "Família com criança sem improvisar", desc: "Onde dormir longe do bar, kid clubs sérios, Aquarium × Tiger Zoo, scooter com kid (NÃO) e templo com lagoa de carpa." },
    { title: "Apoie santuário ético (não maus-tratos disfarçado)", desc: "Samui Elephant Sanctuary verdade, Trash Hero clean-up, eco resorts certificados e reef-safe sunscreen." },
    { title: "Reserve no mês certo antes de tudo esgotar", desc: "Réveillon 5-6 meses, Kamalaya 3-4, alta seca 6-8 semanas, baixa 1-2, monção véspera." },
  ],
  comparison: {
    theirs: [
...
const tao = make(ilhasMeta[4], {
  ...
  features: [
    { title: "Escolha a escola PADI sem cair no banner do pier", desc: "10 escolas aprovadas com Google Maps, site e Instagram — critério real em vez de marketing." },
    { title: "Faça Open Water → Instrutor sem refazer conta", desc: "Tabela de prazo e preço real de cada nível (Open Water, Advanced, Rescue, Divemaster, IDC) — sem surpresa entre fases." },
    { title: "Pague R$ 600 no Open Water (não R$ 1.800 online)", desc: "6 instrutores brasileiros que dão aula em PT + script de negociação no pier — mesma certificação PADI por 1/3 do preço." },
    { title: "Não vire estatística no primeiro dive", desc: "Checklist do mergulhador brasileiro: seguro DAN, atestado, regra das 18h sem voar, álcool, hidratação — o que ninguém te conta." },
    { title: "Entenda o briefing PADI inteiro", desc: "Glossário com 12 termos (buoyancy, NDL, safety stop, bends) em português — entre na água entendendo tudo." },
    { title: "Pegue o ferry certo (não o caro nem o lento)", desc: "9 rotas com Lomprayah, Seatran e Songserm lado a lado — horários, duração e preço." },
    { title: "Mergulhe no mês de visibilidade real", desc: "Calendário mês a mês — janela de ouro, janela ruim e os meses de whale shark em Sail Rock." },
    { title: "Não fique sem sinal nem sem dinheiro", desc: "SIM, eSIM, Wi-Fi por região + ATM, câmbio e cartão sem dor — economiza R$ 50 por saque." },
    { title: "12 erros caros decifrados (em R$)", desc: "Aprenda com quem já errou — cada erro com o valor exato do prejuízo." },
    { title: "Durma em Tanote por R$ 50 ou em Jansom por R$ 1.500", desc: "Hostels, hotéis e pool villas testados nas 6 baías — com Maps." },
    { title: "Suba o John-Suwan às 5h45 (não às 14h suado)", desc: "A foto que vira capa de viagem com plano operacional: trilha, taxa, horário do nascer do sol mês a mês." },
    { title: "Saiba se Sail Rock rende no SEU mês", desc: "Chumphon, Sail Rock, Southwest, Twins, Sattakut, White Rock × melhor mês — pra não pagar dive em mar de 3m." },
    { title: "Rode a ilha de scooter sem capotar", desc: "Loop Mae Haad ↔ Sairee ↔ Chalok ↔ Tanote ↔ Aow Leuk com km, tempo e onde 110cc não aguenta dois." },
    { title: "Vá no mês exato pro SEU perfil", desc: "Open Water iniciante, caçador de whale shark, fun diver, festeiro de Full Moon, família — cada um tem janela própria." },
    { title: "Escolha entre Tao, Phangan e Samui sem chutar", desc: "Comparativo de 7 dimensões pra decidir qual ilha do Golfo combina (ou se rola as 3)." },
    { title: "Faça night dive e liveaboard sem cair em armação", desc: "Sail Rock noturno, White Rock à noite e raros liveaboards de 3 dias — quando reservar e quanto custa." },
    { title: "Pesque lula com pescador local de Mae Haad", desc: "Squid fishing noturno com jantar no convés — preço, contato e o que esperar." },
    { title: "Resolva torcicolo de regulador no spa certo", desc: "Jamahkiri, Healing Hands e Ban's Spa — qual resolve dor pós-dive e qual é fine dining wellness." },
    { title: "Fuja de Sairee sem perder Koh Tao", desc: "Tanote, Aow Leuk e Sai Nuan: praias escondidas a 15 min do bar — onde dormir longe da festa." },
    { title: "Mergulhe com criança a partir de 8 anos", desc: "Bubblemaker PADI, Shark Bay snorkel raso, hospedagem sem escada e o que NÃO fazer com criança." },
    { title: "Plante coral em vez de só consumir", desc: "Save Koh Tao: New Heaven coral nursery, conte tubarão filhote em Shark Bay, beach clean-up mensal com café free." },
    { title: "Reserve no mês certo antes de tudo esgotar", desc: "Timeline pra Réveillon, whale shark season, alta europeia e baixa — sem pagar overprice nem ficar sem vaga." },
  ],
  comparison: {
    theirs: [
  ...
  finalCTA: {
    ...
    subtitle: "O Rafael economizou R$ 1.270 só negociando o Open Water com o script do guia — sobrou pra 2 dives em Sail Rock. Por R$ 67 (12x R$ 6,71) você compra o filtro das 70+ escolas da ilha. Baixa agora, lê em 1 hora, embarca sabendo onde mergulhar.",
  },
});
...
const chang = make(ilhasMeta[5], {
  ...
  features: [
    { title: "Escolha a praia certa pelo mapa N→S", desc: "Tabela visual das 7 praias-bairro com tag de perfil e lado da ilha — em 30 segundos você decide onde dormir." },
    { title: "Não reserve White Sand achando que é selvagem", desc: "As 7 praias decodificadas: quem deve ficar em cada uma e quem precisa fugir antes de pagar a diária." },
    { title: "Vá no mês certo (chuva, vento, viz e diária)", desc: "Janela climática mês a mês com lotação real e preço médio de hotel mid-range — acerta o mês ANTES de comprar passagem." },
    { title: "Faça o combo Chang + Mak + Kood + Wai sem perder ferry", desc: "Qual ilha pra qual perfil, dias ideais e tabela de ferries entre as 4 (alta nov-mai)." },
    { title: "Mergulhe Koh Rang no mês de viz real", desc: "5 dive sites (HTMS Chang wreck, Pinnacle, Hin Luk Bat) com nível, profundidade, melhor época e preço real em R$." },
    { title: "Atravesse pro Camboja sem cair em scam", desc: "Hat Lek → Koh Kong → Sihanoukville em 5 passos + os 5 golpes de fronteira com a resposta exata." },
    { title: "Não pague R$ 60 de ingresso em cachoeira seca", desc: "5 cachoeiras avaliadas com mês a mês — qual paga, qual é grátis, qual vale, qual pular." },
    { title: "Veja o pôr do sol no spot certo na hora certa", desc: "6 sunset spots ranqueados com horário ideal de chegada e dica de local — Kai Bae, Bang Bao, Klong Kloi e mais." },
    { title: "Chegue em Long Beach (Hat Yao) sem ficar preso na maré", desc: "Trilha de 2,8 km de selva fechada com tabela de maré obrigatória, checklist e os perigos reais." },
    { title: "Saia de balada no bar certo do seu estilo", desc: "6 bares mapeados (Lonely, Sabay, Hippie, 15 Palms, Oodie's, Bailan Bay) com vibe, preço e endereço." },
    { title: "Pegue o ferry certo (8 rotas, 3 portos em Trat)", desc: "Bangkok→Trat, 2 portos pra Chang e ferries sazonais pra Mak, Kood, Wai e fronteira do Camboja — print no celular." },
    { title: "Apoie santuário ético de verdade (e desmascare os falsos)", desc: "Ban Kwan Chang — único ético em Chang (SEM banho, SEM montaria, SEM foto em cima) + o filtro pra reconhecer qualquer outro." },
    { title: "Coma por R$ 12 em vez de R$ 80 na praia", desc: "4 night markets com endereço (White Sand, Klong Prao, Bang Bao pier, Salakphet) onde tailandês come de verdade." },
    { title: "Embarque com o checklist pronto", desc: "PID, seguro com scooter, repelente, reef-safe, vacina — o que resolver antes de sair do Brasil." },
    { title: "Tenha sinal onde a ilha morre", desc: "SIM, eSIM e Wi-Fi por região: qual operadora pega em Salakphet e como configurar antes de embarcar." },
    { title: "Não jogue R$ 50 fora em taxa de ATM", desc: "1 saque grande no único Aeon Bank da ilha + estratégia de câmbio e cartão sem dor." },
    { title: "Aprenda com os 8 erros caros (em R$)", desc: "Cada erro com o valor real do prejuízo — você lê em 5 minutos e economiza milhares." },
    { title: "Siga roteiro pronto 3, 5, 7 ou 10 dias", desc: "Para mochileiro, casal, família ou combo Chang + Mak + Kood do arquipélago de Trat." },
  ],
  comparison: {
    theirs: [
...
const lanta = make(ilhasMeta[6], {
  ...
  features: [
    { title: "Escolha a praia certa pelas 9 da fila N→S", desc: "Klong Dao, Phra Ae, Klong Khong, Klong Nin, Kantiang, Bamboo — qual é cada uma, pra quem e por quanto." },
    { title: "Vá no mês exato (chuva, vento, viz e diária)", desc: "Tabela dos 12 meses pra não pegar ilha vazia em julho nem hotel fechado em setembro." },
    { title: "Rode Lanta inteira em 1 dia (loop de 80 km)", desc: "Rota norte→sul com 9 paradas e horário. Termina vendo o pôr do sol em Bamboo Bay." },
    { title: "Veja o pôr do sol no bar certo do sul", desc: "5 sunset bars ranqueados (Same Same, Why Not, Funky Fish, Where Else?, Mirador Pimalai) com nota e horário." },
    { title: "Chegue no Old Town na hora que ele vive", desc: "Por que ir só depois das 17h, night market das terças e os 3 restaurantes em palafita que valem." },
    { title: "Não caia nos 12 golpes da ilha", desc: "Scooter, taxi, tour, ATM, polícia — script exato de resposta pra cada um." },
    { title: "Mergulhe Koh Haa, Hin Daeng e Hin Muang no mês de viz real", desc: "Tabela mês-a-mês com janela de manta ray e whale shark — pra mergulhar quando rende." },
    { title: "Saiba quanto tempo leva entre cada praia de scooter", desc: "8 trechos cronometrados entre Saladan, Klong Dao, Phra Ae, Klong Nin, Kantiang, Bamboo, Tanod e Old Town." },
    { title: "Vá no mês exato pro SEU perfil", desc: "Tabela cruzada mês × perfil: slow travel, família, mergulhador, lua de mel, mochileiro, refúgio pós-Phi Phi." },
    { title: "Escolha entre Lanta, Phi Phi e Krabi sem chutar", desc: "Comparativo de 8 dimensões (custo, vibe, mergulho, família, tempo mínimo) pras 3 bases do Andaman sul." },
    { title: "Pesque com pescador local em Saladan", desc: "Como contratar de verdade, squid fishing noturno e big game — preços reais por pessoa e por barco." },
    { title: "Faça spa e cooking class sem cair em pacote turistão", desc: "Oasis Yoga, Sri Lanta, Layana, Pimalai e Time for Lime — drop-in, programas e quanto custa." },
    { title: "Chegue em Bamboo, Mai Pai e Mu Ko Lanta NP", desc: "Como chegar, quanto custa e por que vale ir nas 5 áreas isoladas do sul." },
    { title: "Família com criança sem improvisar", desc: "Praias OK, hospital, bairros recomendados, datas a evitar — sem ilusão." },
    { title: "Não destrua o que veio ver", desc: "6 regras locais: reef-safe em Koh Haa, sem âncora em Hin Daeng, Emerald Cave fora do pico." },
  ],
  comparison: {
    theirs: [
...
const lipe = make(ilhasMeta[7], {
  ...
  features: [
    { title: "Chegue em Lipe sem dormir em rodoviária", desc: "Os 4 trechos Bangkok ⇒ Hat Yai ⇒ Pakbara ⇒ Lipe com operadora, horário e preço — saia 21h, chegue 13h sem perder conexão." },
    { title: "Não reserve no mês em que o mar fecha", desc: "Tabela dos 12 meses (chuva, vento, visibilidade, preço) — dez-mar é Maldivas, mai-out é ilha morta." },
    { title: "Saiba a visibilidade ANTES de pagar o dive", desc: "Hin Ngam, Jabang, Stonehenge, 8 Mile Rock em metros mês a mês — escolha o mês exato pelo seu dive site." },
    { title: "Escolha a praia certa pro seu perfil (3 erram, 1 acerta)", desc: "Pattaya central, Sunrise família, Sunset mochileiro — escolher errado vira viagem ruim por R$ 800/diária a mais." },
    { title: "Faça snorkel sem 30 barcos em cima", desc: "3 pontos clássicos no horário certo + os 5 desertos que o tour padrão nem cita." },
    { title: "PADI em Lipe sem cair em escola turística", desc: "Open Water R$ 1.600-2.000, escolas honestas, sites por nível e quando compensa Lipe vs. Koh Tao." },
    { title: "Combine Lipe com Lanta, Phi Phi ou Langkawi", desc: "Tabela de speedboats com janela, horário e preço — 2 países num único ferry de 1h." },
    { title: "Apoie os Moken sem virar turista exótico", desc: "Vila, sunrise breakfast em longtail, mercado de peixe 06h, etiqueta — e o que NÃO comprar como \"Moken\"." },
    { title: "Vá no mês exato pro SEU perfil", desc: "Lua de mel: fev. Mergulho: mar-abr. Família: jan/mar. Mochileiro: nov ou abr. Evitar: mai-out e ano-novo." },
    { title: "Não fique sem sinal nem sem dinheiro", desc: "AIS é a ÚNICA que pega. ATM cobra 220 baht. Lipe sem banco — quanto trazer em cash por perfil." },
    { title: "Família/saúde sem risco de evacuação cara", desc: "Clínica única, emergência = Satun (4-5h), seguro com evacuação marítima obrigatório, kit básico." },
    { title: "12 golpes de Lipe com resposta pronta", desc: "Taxa do parque, mini-van fura conexão, tour cortado, ATM caro — script exato pra cada um." },
  ],
  comparison: {
    theirs: [
