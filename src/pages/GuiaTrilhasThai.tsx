...
import heroTrekking from "@/assets/generated/trilhas-hero.png.asset.json";
  ...
  return (
    <div className="min-h-screen bg-elephant-bg font-body text-elephant-fg">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <img src={heroTrekking.url} alt="Trilha de trekking na selva tailandesa" {...({ fetchpriority: "high" } as any)} decoding="async" className="absolute inset-0 w-full h-full object-cover" width={1920} height={1080} />
