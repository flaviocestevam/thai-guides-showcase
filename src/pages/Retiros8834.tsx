...
const yoga: Retreat[] = [
  ...
  r({ name: "Orion Healing Center", city: "Koh Phangan", address: "Srithanu Beach", type: "Yoga + detox + jejum", level: "Iniciante", duration: "3, 7 ou 14 dias", price: "฿12.000–฿45.000 (R$ 1.750–R$ 6.500)", language: "Inglês", tip: "Combo detox + yoga é o carro-chefe. Médico naturopata na equipe.", rating: 9 }),
  r({ name: "Samma Karuna", city: "Koh Phangan", address: "Sri Thanu", type: "Yoga, tantra, breathwork, ice bath", level: "Intermediário", duration: "1 a 4 semanas", price: "฿22.000–฿70.000 (R$ 3.200–R$ 10.200)", language: "Inglês", tip: "Comunidade forte, professores brasileiros frequentes. Peça calendário pt-br.", rating: 9 }),
  r({ name: "Yoga Retreat Koh Phangan (The Sanctuary)", city: "Koh Phangan", address: "Haad Tien Beach, sudeste", type: "Yoga, detox, healing", level: "Todos", duration: "Open (mín. 3 noites)", price: "฿2.500–฿6.000/noite + aulas", language: "Inglês", tip: "Só se chega de barco. Isolamento total — bom pra desintoxicar do mundo.", rating: 9 }),
  r({ name: "Wise Living Yoga Academy", city: "Chiang Mai", address: "Mae Rim, 25min do centro", type: "YTT 200h/300h Yoga Alliance", level: "Intermediário", duration: "21 a 28 dias", price: "฿65.000–฿95.000 (R$ 9.500–R$ 13.800)", language: "Inglês", tip: "TTC sério, fora do circuito 'instagrammer'. Inclui anatomia clínica.", rating: 9 }),
  r({ name: "Yoga Tree Chiang Mai", city: "Chiang Mai", address: "Sirimangkalajarn Rd, Nimman", type: "Hatha, vinyasa, yin (drop-in + retiros)", level: "Iniciante", duration: "3 a 7 dias", price: "฿8.000–฿18.000 (R$ 1.170–R$ 2.620)", language: "Inglês", tip: "Bom pra primeiro retiro. Combina aulas com vida na cidade.", rating: 8 }),
  r({ name: "Vikasa Yoga Retreat", city: "Koh Samui", address: "Lamai sul, à beira-mar", type: "Yoga, breathwork, sound healing", level: "Todos", duration: "5 a 14 dias", price: "฿32.000–฿110.000 (R$ 4.650–R$ 16.000)", language: "Inglês", tip: "Estrutura premium em falésia. Peça o quarto 'Cliff' — vista direta no Golfo.", rating: 10 }),
  r({ name: "Kamalaya Wellness Sanctuary", city: "Koh Samui", address: "Laem Set, sul da ilha", type: "Yoga + medicina chinesa + ayurveda", level: "Todos", duration: "5 a 21 dias", price: "฿120.000–฿400.000 (R$ 17.500–R$ 58.000)", language: "Inglês (concierge pt-br)", tip: "Top mundial. Programa 'Burnout' tem médico dedicado. Caro, mas entrega.", rating: 10 }),
  r({ name: "Absolute Sanctuary", city: "Koh Samui", address: "Choeng Mon", type: "Yoga, pilates, detox, fitness", level: "Todos", duration: "3 a 14 dias", price: "฿40.000–฿150.000 (R$ 5.800–R$ 21.800)", language: "Inglês", tip: "Mais fitness que espiritual. Bom pra quem odeia incenso.", rating: 9 }),
  r({ name: "Pyramid Yoga Center", city: "Koh Phangan", address: "Sri Thanu", type: "Pirâmide energética + yoga + raw food", level: "Intermediário", duration: "7 a 28 dias", price: "฿20.000–฿60.000 (R$ 2.900–R$ 8.700)", language: "Inglês", tip: "Conceito alternativo dentro de pirâmide. Comida raw vegan inclusa.", rating: 8 }),
];

const vipassana: Retreat[] = [
  r({ name: "Wat Suan Mokkh (International Dharma Hermitage)", city: "Chaiya, Surat Thani", address: "Wat Suan Mokkh Palaram, Chaiya", type: "Vipassana + Anapanasati, silêncio total", level: "Iniciante", duration: "10 dias (dia 1 a 10 de cada mês)", price: "POR DOAÇÃO — sugerido ฿2.000 (R$ 290)", language: "Inglês", tip: "Maior retiro por doação da Tailândia. Chegue dia 30/31 ou último dia do mês pra registro presencial. Sem celular, acordar 4h, refeições antes do meio-dia.", rating: 10 }),
  r({ name: "Wat Pa Tam Wua Forest Monastery", city: "Mae Hong Son", address: "Mae La Noi, 160km de Chiang Mai", type: "Vipassana floresta, monges thai", level: "Iniciante", duration: "Aberto (3 a 30 dias)", price: "POR DOAÇÃO", language: "Inglês básico + thai", tip: "Vagas livres — chegue a qualquer dia. Roupas brancas fornecidas. Caminhada meditativa pela floresta diariamente.", rating: 10 }),
  r({ name: "Dhamma Kamala (Vipassana Centre Thailand)", city: "Prachinburi", address: "Saen Phuday, 2h30 de Bangkok", type: "Vipassana S.N. Goenka tradição", level: "Iniciante", duration: "10 dias (calendário fixo)", price: "POR DOAÇÃO", language: "Áudio em inglês + thai", tip: "Linhagem Goenka pura. Inscrição online com 2 meses antes — fila grande.", rating: 10 }),
  r({ name: "Dhamma Abha", city: "Phitsanulok", address: "Wang Thong, Phitsanulok", type: "Vipassana Goenka", level: "Iniciante", duration: "10 dias", price: "POR DOAÇÃO", language: "Inglês + thai", tip: "Mais vagas que Dhamma Kamala. Boa alternativa se Prachinburi estiver lotado.", rating: 9 }),
  r({ name: "Wat Ram Poeng (Northern Insight Meditation Center)", city: "Chiang Mai", address: "Suthep, atrás de Wat Umong", type: "Vipassana Mahasi Sayadaw", level: "Intermediário", duration: "26 dias (programa completo) ou 10 dias intro", price: "POR DOAÇÃO — sugerido ฿200/dia", language: "Inglês", tip: "Programa sério com entrevistas diárias com mestre. Cabine privativa.", rating: 9 }),
  r({ name: "Doi Suthep Vipassana Center (Wat Phra That)", city: "Chiang Mai", address: "Doi Suthep mountain", type: "Vipassana fundamentals", level: "Iniciante", duration: "3, 10 ou 21 dias", price: "POR DOAÇÃO — ฿500–฿1.500 sugerido", language: "Inglês", tip: "Vista de montanha. Bom pra primeira vez — tem curso 'fundamentals' de 3 dias.", rating: 9 }),
  r({ name: "International Forest Monastery (Wat Pah Nanachat)", city: "Ubon Ratchathani", address: "Bung Wai, Warin Chamrap", type: "Tradição Ajahn Chah, monástica", level: "Avançado", duration: "Aberto (1 semana mínimo)", price: "POR DOAÇÃO", language: "Inglês", tip: "Mosteiro de monges ocidentais. Disciplina pesada — só pra quem já meditou.", rating: 10 }),
  r({ name: "Wat Mahathat Section 5", city: "Bangkok", address: "Maharaj Rd, ao lado do Grand Palace", type: "Vipassana intro no centro de Bangkok", level: "Iniciante", duration: "3 a 7 dias (aberto)", price: "POR DOAÇÃO", language: "Inglês", tip: "Pra quem quer experimentar antes de comprometer 10 dias. Bem no centro.", rating: 8 }),
  r({ name: "Wat Khao Tham", city: "Koh Phangan", address: "topo da colina, centro de Koh Phangan", type: "Vipassana em monastério de ilha", level: "Intermediário", duration: "10 ou 20 dias (calendário)", price: "POR DOAÇÃO — ฿6.500 sugerido", language: "Inglês", tip: "Único Vipassana sério em ilha. Calor + insetos — não é pra fracos.", rating: 9 }),
  r({ name: "Sunyata Retreats", city: "Khon Kaen", address: "Nong Wang, Khon Kaen", type: "Mindfulness + zen ocidental", level: "Iniciante", duration: "5 a 10 dias", price: "฿15.000–฿28.000 (R$ 2.180–R$ 4.060)", language: "Inglês", tip: "Não é doação, mas estrutura confortável pra quem não topa templo cru.", rating: 8 }),
];

const detox: Retreat[] = [
  r({ name: "Sanctuary Detox", city: "Koh Phangan", address: "Haad Tien Beach", type: "Detox de suco + jejum + colônica", level: "Iniciante", duration: "3, 7 ou 14 dias", price: "฿25.000–฿85.000 (R$ 3.640–R$ 12.380)", language: "Inglês", tip: "Detox mais famoso da ilha. Inclui yoga, massagem e consultoria com naturopata.", rating: 9 }),
  r({ name: "Atmanjai Wellness Centre", city: "Phuket", address: "Patong", type: "Detox supervisionado, jejum, raw food", level: "Iniciante", duration: "7 a 21 dias", price: "฿55.000–฿180.000 (R$ 8.000–R$ 26.200)", language: "Inglês", tip: "Médico ayurvédico residente. Programa sério, não 'wellness instagram'.", rating: 10 }),
  r({ name: "Phuket Cleanse", city: "Phuket", address: "Nai Harn", type: "Fitness + detox + intermittent fasting", level: "Intermediário", duration: "7 a 28 dias", price: "฿60.000–฿200.000 (R$ 8.740–R$ 29.100)", language: "Inglês", tip: "Detox com treino funcional pesado. Pra quem quer perder peso de verdade.", rating: 9 }),
  r({ name: "Kamalaya Optimal Fitness & Detox", city: "Koh Samui", address: "Laem Set", type: "Detox + medicina integrativa", level: "Todos", duration: "5 a 14 dias", price: "฿140.000+ (R$ 20.400+)", language: "Inglês", tip: "Versão detox do Kamalaya. Caro mas com médico, nutricionista e terapeuta.", rating: 10 }),
  r({ name: "The Spa Resorts Koh Chang", city: "Koh Chang", address: "Klong Prao Beach", type: "Detox + raw food + yoga", level: "Iniciante", duration: "3 a 14 dias", price: "฿18.000–฿70.000 (R$ 2.620–R$ 10.200)", language: "Inglês", tip: "Versão mais barata e tranquila de Koh Phangan. Praia bonita, longe da balada.", rating: 8 }),
  r({ name: "Mantra Detox", city: "Koh Phangan", address: "Sri Thanu", type: "Suco + colônica + meditação", level: "Iniciante", duration: "5 a 10 dias", price: "฿15.000–฿35.000 (R$ 2.180–R$ 5.100)", language: "Inglês", tip: "Custo-benefício forte. Sem luxo, mas com supervisão.", rating: 8 }),
  r({ name: "RAKxa Wellness & Medical Retreat", city: "Bangkok (Bang Krachao)", address: "Bang Nam Phueng, Phra Pradaeng", type: "Detox médico integrativo", level: "Todos", duration: "3 a 14 dias", price: "฿80.000–฿300.000 (R$ 11.650–R$ 43.700)", language: "Inglês (pt-br concierge)", tip: "Único na 'ilha verde' de Bangkok. Médicos com PhD, exames de sangue inclusos.", rating: 10 }),
];

const plantMedicine: Retreat[] = [
  r({ name: "Phangan Kratom Center", city: "Koh Phangan", address: "Sri Thanu", type: "Kratom (planta legal) + meditação", level: "Iniciante", duration: "5 a 14 dias", price: "฿18.000–฿50.000 (R$ 2.620–R$ 7.280)", language: "Inglês", tip: "Kratom é legal na Tailândia desde 2021. Ritual leve, não psicodélico.", rating: 8 }),
  ...
  r({ name: "Mushroom Magic Koh Pha Ngan", city: "Koh Phangan", address: "(consulta privada)", type: "Cogumelo (cinza legal — sob ritual em templo)", level: "Avançado", duration: "1 a 3 dias", price: "Por consulta", language: "Inglês", tip: "Status legal cinza. Faça apenas com facilitadores experientes e supervisão médica — risco real existe.", rating: 6 }),
  r({ name: "Sacred Sound Healing (Pun Pun)", city: "Chiang Mai", address: "Mae Taeng", type: "Cerimônias de cacau + som + plantas locais", level: "Iniciante", duration: "3 a 7 dias", price: "฿12.000–฿30.000 (R$ 1.750–R$ 4.370)", language: "Inglês", tip: "Alternativa segura e legal a psicodélicos. Cacau cerimonial + gongo + breathwork.", rating: 8 }),
];

const danceExpression: Retreat[] = [
  r({ name: "Ecstatic Dance Sri Thanu", city: "Koh Phangan", address: "Pyramid Yoga, Sri Thanu", type: "Dança extática + breathwork", level: "Iniciante", duration: "Weekly (drop-in) ou retiros 5 dias", price: "฿200/sessão · retiros ฿15.000+", language: "Inglês", tip: "Cena mais forte de ecstatic dance da Ásia. Vá descalço.", rating: 9 }),
  r({ name: "Embodied Tantra Retreat (Samma Karuna)", city: "Koh Phangan", address: "Sri Thanu", type: "Tantra + movimento + voz", level: "Intermediário", duration: "7 a 21 dias", price: "฿28.000–฿85.000 (R$ 4.080–R$ 12.380)", language: "Inglês", tip: "Sério, terapêutico. Não confunda com 'tantra sexual' de Instagram.", rating: 9 }),
  r({ name: "5Rhythms Thailand", city: "Chiang Mai", address: "Nimman, salões rotativos", type: "Dança 5Rhythms de Gabrielle Roth", level: "Iniciante", duration: "Workshops 3 dias", price: "฿8.000–฿18.000 (R$ 1.170–R$ 2.620)", language: "Inglês", tip: "Linhagem oficial certificada. Calendário irregular — siga no Facebook.", rating: 8 }),
  r({ name: "Breathwork Bali Style (Koh Phangan)", city: "Koh Phangan", address: "Various — Sri Thanu cluster", type: "Holotropic + Wim Hof + ice bath", level: "Todos", duration: "3 a 7 dias", price: "฿12.000–฿35.000 (R$ 1.750–R$ 5.100)", language: "Inglês", tip: "Vários professores rodando workshops. Pergunte por 'Joaquin' ou 'Inga' — referências locais.", rating: 9 }),
];

const silence: Retreat[] = [
  r({ name: "Wat Suan Mokkh (silêncio dentro do Vipassana)", city: "Chaiya, Surat Thani", address: "ver Vipassana", type: "Silêncio total 10 dias", level: "Iniciante", duration: "10 dias", price: "POR DOAÇÃO", language: "Inglês", tip: "Já listado em Vipassana. Silêncio é parte integral do programa.", rating: 10 }),
  r({ name: "Wat Pa Tam Wua (silêncio aberto)", city: "Mae Hong Son", address: "ver Vipassana", type: "Silêncio + caminhada meditativa", level: "Iniciante", duration: "Flexível", price: "POR DOAÇÃO", language: "Inglês", tip: "Você define quantos dias em silêncio. Bom pra 1ª vez.", rating: 10 }),
  r({ name: "Wat Khao Tham Silent Retreat", city: "Koh Phangan", address: "ver Vipassana", type: "Silêncio em monastério de ilha", level: "Intermediário", duration: "10 ou 20 dias", price: "POR DOAÇÃO", language: "Inglês", tip: "Silêncio + calor de ilha. Desafio físico extra.", rating: 9 }),
  r({ name: "Plum Village Thailand (Thai Plum Village)", city: "Pak Chong, Khao Yai", address: "Nakhon Ratchasima", type: "Mindfulness Thich Nhat Hanh + 'noble silence'", level: "Iniciante", duration: "5 a 21 dias (calendário)", price: "POR DOAÇÃO — ฿4.500 sugerido/semana", language: "Inglês + vietnamita + thai", tip: "Linhagem direta de Thich Nhat Hanh. Silêncio nobre nas refeições e manhãs.", rating: 10 }),
];
